...
std::vector<qrobot_msg_type1> g_algo1_out,g_algo1_in_1,g_algo1_in_3;
std::vector<qrobot_msg_type2> g_algo1_in_2;
std::vector<qrobot_msg_type1> g_algo2_out,g_algo2_in_1,g_algo2_in_2,g_algo2_in_3;
std::vector<qrobot_msg_type1> g_algo3_out,g_algo3_in_1,g_algo3_in_2,g_algo3_in_3;
...
public:
   algo_task1(std::string str):TASK_NAME(str){};
	...
	void callback_1_1(qrobot_msg_type1& msg1)
     {
  std::cout<<"\n" <<" TASK_NAME("<< TASK_NAME<<").FUCTION(" << __FUNCTION__  << ")-msg.frameid["<<msg1.frameid<<"]" << std::endl;
   ...
   void operator() () {
	...
	mbus1.subscribe(TASK_NAME,"topic1",1000,0,std::bind(&algo_task1::callback_1_1,this,std::placeholders::_1),error);
	mbus2.subscribe(TASK_NAME,"topic2",1000,0,std::bind(&algo_task1::callback_1_2,this,std::placeholders::_1),error);
	mbus1.subscribe(TASK_NAME,"topic3",1000,0,std::bind(&algo_task1::callback_1_3,this,std::placeholders::_1),error);
	int i=1;
	while (i<g_runs) {
        qrobot_msg_type1 msg1;
        msg1.frameid=i;
//	msg.map2d.push_back(std::vector<float>(4, 1.0));
	{
	// g_mut_log.lock();
	mbus1.publish(TASK_NAME,"topic1",msg1,0,error);
	g_algo1_out.push_back(msg1);	
  	mbus2.spinOne(TASK_NAME,"topic2",0,0,error);
	mbus1.spinOne(TASK_NAME,"topic3",0,0,error);
	mbus1.spinOne(TASK_NAME,"topic1",0,0,error);
...
public:
  ...
  std::cout<<"\n" << "TASK_NAME("<< TASK_NAME<<").FUCTION(" << __FUNCTION__  << ")-msg.frameid["<<msg.frameid<<"]" << std::endl;
        g_algo2_in_1.push_back(msg);
     }
	
	void callback_2_2(qrobot_msg_type1& msg)
     {
     std::cout<<"\n" << "TASK_NAME("<< TASK_NAME<<").FUCTION(" << __FUNCTION__  << ")-msg.frameid["<<msg.frameid<<"]" << std::endl;
        g_algo2_in_2.push_back(msg);
     }

	void callback_2_3(qrobot_msg_type1& msg)
     {
     std::cout<<"\n" << "TASK_NAME("<< TASK_NAME<<").FUCTION(" << __FUNCTION__  << ")-msg.frameid["<<msg.frameid<<"]" << std::endl;
        g_algo2_in_3.push_back(msg);
     }
   ...
   void operator() () {
	...
	while (i<g_runs) {
        ...
        msg.frameid=i;
	msg.map2d.push_back(std::vector<float>(4, 2.0));
	{
	// g_mut_log.lock();
	mbus.publish(TASK_NAME,"topic2",msg,0,error);
	g_algo2_out.push_back(msg);	
...
public:
   algo_task3(std::string str):TASK_NAME(str){};
	...
	void callback_3_1(qrobot_msg_type1& msg)
     {
  std::cout<<"\n" << "TASK_NAME("<< TASK_NAME<<").FUCTION(" << __FUNCTION__  << ")-msg.frameid["<<msg.frameid<<"]" << std::endl;
        g_algo3_in_1.push_back(msg);
     }
	
	void callback_3_2(qrobot_msg_type1& msg)
     {
     std::cout<<"\n" << "TASK_NAME("<< TASK_NAME<<").FUCTION(" << __FUNCTION__  << ")-msg.frameid["<<msg.frameid<<"]" << std::endl;
        g_algo3_in_2.push_back(msg);
     }

	void callback_3_3(qrobot_msg_type1& msg)
     {
     std::cout<<"\n" << "TASK_NAME("<< TASK_NAME<<").FUCTION(" << __FUNCTION__  << ")-msg.frameid["<<msg.frameid<<"]" << std::endl;
        g_algo3_in_3.push_back(msg);
     }
   ...
   void operator() () {
	...
	while (i<g_runs) {
        qrobot_msg_type1 msg;
        msg.frameid=i;
	msg.map2d.push_back(std::vector<float>(4, 3.0));
	{
	// g_mut_log.lock();
	mbus.publish(TASK_NAME,"topic3",msg,0,error);
	g_algo3_out.push_back(msg);	
  	mbus.spinOne(TASK_NAME,"topic2",0,0,error);
	mbus.spinOne(TASK_NAME,"topic3",0,0,error);
	mbus.spinOne(TASK_NAME,"topic1",0,0,error);
