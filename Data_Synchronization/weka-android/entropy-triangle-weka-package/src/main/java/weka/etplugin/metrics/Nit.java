...
public class Nit extends AbstractEvaluationMetric implements StandardEvaluationMetric, TechnicalInformationHandler {
	...
	/** For serialization */
	private static final long serialVersionUID = -3423158014884796158L;
	...
	public double getStatistic(String statName) {
		...
		return informationTransferFactor / cf.length;
	}
	...
	public String toSummaryString() {
		...
		text.append(Utils.doubleToString(getStatistic(Nit.METRIC_NAME), 9, 4) + "\n");
